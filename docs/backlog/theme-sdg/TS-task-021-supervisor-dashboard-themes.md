# TS-task-021 — Theme Display on Supervisor Dashboard
...
**Dependencies**: [TS-task-009](TS-task-009-backend-themes-in-business-query.md) (theme data in project responses)  
...
- **Data source**: The supervisor dashboard already loads project data. After [TS-task-009](TS-task-009-backend-themes-in-business-query.md), each project object will include a `themes` array.
