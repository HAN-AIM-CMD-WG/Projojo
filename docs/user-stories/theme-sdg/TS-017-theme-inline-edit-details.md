# TS-017 — Inline Theme Editing on ProjectDetailsPage
...
**Dependencies**: [TS-014](TS-014-theme-picker-component.md), [TS-019](TS-019-project-details-theme-display.md) (read-only display must exist first)  
...
- **Component**: Use `<ThemePicker readOnly={!isEditing} initialSelected={currentThemeIds} onChange={...}>` from [TS-014](TS-014-theme-picker-component.md)
- **Service calls**: 
