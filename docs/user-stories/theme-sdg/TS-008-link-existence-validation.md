# TS-008 — Validate Theme and Project Existence in Link Endpoint
...
**Dependencies**: [TS-005](TS-005-atomic-theme-linking.md) (atomic linking must be in place first)  
...
- This story depends on [TS-005](TS-005-atomic-theme-linking.md) because existence validation should happen before the atomic write transaction
