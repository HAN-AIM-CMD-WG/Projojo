# TS-010 — Theme Management List on TeacherPage
...
- This story handles the read/display portion. Create ([TS-011](TS-011-theme-create-modal.md)), edit ([TS-012](TS-012-theme-edit-modal.md)), and delete ([TS-013](TS-013-theme-delete-confirmation.md)) are separate stories
