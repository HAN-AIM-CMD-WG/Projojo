# TS-013 — Theme Delete with Confirmation Dialog
...
**Dependencies**: [TS-010](TS-010-theme-management-list.md), [TS-002](TS-002-project-deletion-cascade.md) (cascade must work first)  
...
**Then** all 3 `hasTheme` relations are removed server-side (verified by [TS-002](TS-002-project-deletion-cascade.md) backend fix)  
