# TS-016 — Theme Selection on Project Edit
...
**Dependencies**: [TS-014](TS-014-theme-picker-component.md), [TS-003](TS-003-link-ownership-enforcement.md) + [TS-005](TS-005-atomic-theme-linking.md)  
...
- **Component**: Use `<ThemePicker initialSelected={currentThemeIds} onChange={setSelectedThemes}>` from [TS-014](TS-014-theme-picker-component.md)
