# TS-007 — Replace Silent Exception Swallowing with Logging
...
**Then** a warning is logged with the exception details  
**And** the operation behavior follows the atomic linking pattern (see [TS-005](TS-005-atomic-theme-linking.md))
