# TS-012 — Theme Edit Modal for Teachers
...
**Dependencies**: [TS-010](TS-010-theme-management-list.md), [TS-011](TS-011-theme-create-modal.md) (reuse form component), [TS-004](TS-004-theme-input-validation.md) (backend validation)  
...
- **Reuse**: Same form layout as [TS-011](TS-011-theme-create-modal.md) create modal — extract a shared `ThemeForm` sub-component
