# TS-015 — Theme Selection on Project Creation
...
**Dependencies**: [TS-014](TS-014-theme-picker-component.md) (ThemePicker component), [TS-003](TS-003-link-ownership-enforcement.md) + [TS-005](TS-005-atomic-theme-linking.md) + [TS-008](TS-008-link-existence-validation.md) (backend linking must be secure and atomic)  
...
- **Component**: Use `<ThemePicker>` from [TS-014](TS-014-theme-picker-component.md)
