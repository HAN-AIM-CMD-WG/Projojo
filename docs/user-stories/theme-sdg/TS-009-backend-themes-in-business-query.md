# TS-009 — Add Theme Sub-query to getBusinessesComplete() Endpoint

**Phase**: 2 — UI Workflows  
**Priority**: 🔴 High (blocks multiple frontend stories)  
...
- **TypeQL addition** to the business query:
  ...
  ```
- This is the backend prerequisite for [TS-018](TS-018-projectcard-theme-badges.md), [TS-020](TS-020-overviewpage-theme-fix.md), and [TS-021](TS-021-supervisor-dashboard-themes.md)
