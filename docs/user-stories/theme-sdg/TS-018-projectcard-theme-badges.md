# TS-018 — Theme Badges on Authenticated ProjectCard
...
**Then** it reads from `project.themes` array (added by [TS-009](TS-009-backend-themes-in-business-query.md))  
...
- **Pattern to match**: [`PublicProjectCard.jsx:56-68`](../../../projojo_frontend/src/components/PublicProjectCard.jsx:56) which renders theme badges with:
  ...
  ```
- **Data source**: `project.themes` array provided by parent component via enriched `getBusinessesComplete()` response ([TS-009](TS-009-backend-themes-in-business-query.md))
