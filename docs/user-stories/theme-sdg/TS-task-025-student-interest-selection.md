# TS-task-025 — Student Interest Selection UI on Profile
...
**Dependencies**: [TS-task-024](TS-task-024-student-interest-backend.md) (backend must exist), [TS-task-014](TS-task-014-theme-picker-component.md) (reuse ThemePicker)  
...
- **Component**: Reuse `<ThemePicker initialSelected={interestIds} onChange={...}>` from [TS-task-014](TS-task-014-theme-picker-component.md)
