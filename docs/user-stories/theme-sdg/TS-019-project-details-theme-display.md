# TS-019 — Theme Display on ProjectDetailsPage
...
**Then** theme pills are not clickable or editable (edit functionality is in [TS-017](TS-017-theme-inline-edit-details.md))
...
- **Component**: Use `<ThemePicker readOnly={true} initialSelected={themeIds}>` from [TS-014](TS-014-theme-picker-component.md) in read-only mode, or render theme pills directly
- This story handles read-only display; inline editing is handled by [TS-017](TS-017-theme-inline-edit-details.md) which builds on top of this
