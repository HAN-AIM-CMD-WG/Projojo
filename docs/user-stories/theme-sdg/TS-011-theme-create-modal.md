# TS-011 — Theme Create Modal for Teachers
...
**Dependencies**: [TS-010](TS-010-theme-management-list.md) (theme list must exist), [TS-001](TS-001-theme-name-uniqueness.md) + [TS-004](TS-004-theme-input-validation.md) (backend validation)  
...
- **Component**: Part of `ThemeManagement.jsx` (from [TS-010](TS-010-theme-management-list.md)), using the existing [`Modal`](../../../projojo_frontend/src/components/Modal.jsx) component
