...
export default function Navbar() {
    ...
    const inactiveNavLink = "flex items-center gap-2 py-2.5 px-5 text-[var(--text-secondary)] font-semibold rounded-2xl hover:text-primary hover:bg-[var(--neu-bg-dark)]/30 transition-all duration-200 md:px-4 md:py-2"
                ...
                <div className="max-w-7xl flex flex-wrap items-center justify-between mx-auto px-6 h-20">
                    ...
                    >
                        <ul className="flex flex-col p-4 md:p-0 gap-2 md:flex-row md:items-center md:gap-2">
                            ...
                            {/* Divider (desktop) */}
                            <li className="hidden md:block w-px h-6 bg-[var(--neu-shadow-dark)]/30 mx-3"></li>
                            ...
                            <li>
                                <button 
                                    ...
                                    className="flex items-center gap-2 py-2.5 px-5 md:px-4 md:py-2 text-[var(--text-secondary)] font-semibold rounded-2xl hover:text-red-500 hover:bg-red-50/50 transition-all duration-200 w-full md:w-auto"
                                ...
                                <li className="flex items-center gap-2 ml-3">
                                    ...
                                    {(authData.type === "student" || authData.type === "supervisor") ? (
                                        <Link 
                                            ...
                                            onClick={() => setIsCollapsed(true)}
                                        >
                                            <div className="w-11 h-11 rounded-full p-0.5 bg-gradient-to-br from-primary to-orange-400 group-hover:scale-105 transition-transform">
                                                <img 
                                                    src={profilePicture} 
                                            ...
                                            <div className="w-3 h-3 bg-green-500 rounded-full absolute bottom-0 right-0 border-2 border-[var(--neu-bg)]"></div>
                                        </Link>
                                    ) : (
                                        /* Non-clickable avatar for teachers */
                                        <div className="group relative">
                                            <div className="w-11 h-11 rounded-full p-0.5 bg-gradient-to-br from-primary to-orange-400">
                                                <img 
                                                    src={profilePicture} 
                                                    className="w-full h-full rounded-full object-cover neu-pressed p-0.5" 
                                                    alt="Profielfoto" 
