        ...
        <div className="relative mb-8">
                ...
                <div className="flex-1 max-w-xl">
                    <form onSubmit={handleSearch} className="flex w-full gap-3">
                        <div className="relative flex-1 group">
                            ...
                            <span className="material-symbols-outlined absolute left-5 top-1/2 -translate-y-1/2 text-[var(--text-muted)] group-focus-within:text-primary transition-colors" aria-hidden="true">
                                search
                            </span>
                            <input
                                id="search"
            ...
            {showMap && businesses.length > 0 && (
                <div className="mt-4 neu-flat p-4 rounded-2xl animate-fade-in">
                    ...
                    <div className="flex flex-wrap items-center gap-4 mb-4">
                        <div className="flex rounded-xl overflow-hidden neu-pressed">
                            <button 
                                className={`px-4 py-2 text-sm font-bold transition-all ${mapView === 'businesses' ? 'bg-primary text-white' : 'text-[var(--text-secondary)] hover:text-primary'}`}
                            ...
                            <button 
                                className={`px-4 py-2 text-sm font-bold transition-all ${mapView === 'projects' ? 'bg-primary text-white' : 'text-[var(--text-secondary)] hover:text-primary'}`}
            ...
            {selectedSkills.length > 0 && !isEditing && (
                <div className="flex flex-wrap items-center gap-3 mt-5">
                    <span className="text-xs font-bold text-[var(--text-muted)] uppercase tracking-wide">Actieve filters:</span>
