                                    ...
                                    {showLocationDropdown && (
                                        <div className="absolute top-full right-0 mt-2 z-50 neu-flat rounded-xl p-1.5 min-w-[200px] animate-fade-in" role="listbox">
                                            <button
                                                ...
                                                className={`w-full text-left px-3 py-2 text-xs rounded-lg transition-colors cursor-pointer ${!locationFilter
                                            ...
                                            {locations.map(loc => (
                                                <button
                                                    ...
                                                    className={`w-full text-left px-3 py-2 text-xs rounded-lg transition-colors cursor-pointer ${locationFilter === loc
                                                            ? 'font-bold text-primary bg-primary/10'
