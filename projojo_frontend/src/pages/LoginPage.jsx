...
export default function LoginPage() {
  return (
    <div className="w-full min-h-dvh flex items-center justify-center">
      <div className="flex flex-col gap-4 w-80 p-4 border border-gray-300 rounded-lg shadow-md">
        ...
        <a href={`${API_BASE_URL}auth/login/github`} className="w-full bg-[#333] text-white font-semibold py-3 px-6 rounded-lg border border-gray-600 hover:bg-[#444] hover:border-gray-500 transition-colors duration-200 flex items-center justify-center gap-3">
