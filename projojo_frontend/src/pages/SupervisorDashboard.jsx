...
import { getSupervisorDashboard, updateRegistration, IMAGE_BASE_URL } from '../services';
                        ...
                        <section className="neu-flat p-6">
                            <div className="flex items-center justify-between mb-5">
                                ...
                                {dashboardData?.pending_registrations?.length > 0 && (
                                    <span className="neu-badge">{dashboardData.pending_registrations.length}</span>
                                )}
                            </div>
                        ...
                        <section className="neu-flat p-6">
                            <div className="flex items-center justify-between mb-5">
                                ...
                                {dashboardData?.projects?.length > 0 && (
                                    <span className="neu-badge">{dashboardData.projects.length}</span>
                                )}
                            </div>
                        ...
                        <section className="neu-flat p-6">
                            <div className="flex items-center justify-between mb-5">
                                ...
                                {dashboardData?.active_students?.length > 0 && (
                                    <span className="neu-badge bg-green-500 text-white">{dashboardData.active_students.length}</span>
                                )}
                            </div>
...
function ActiveStudentCard({ student }) {
    return (
        <Link 
            ...
            className="neu-btn !p-5 !text-left block"
        >
            {/* Student header */}
            <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <span className="neu-badge bg-green-500 text-white text-xs">Actief</span>
                </div>
            </div>
